...
\todo{completei este paragrafo a explicar a aritmetica, acho...}                                            
...
\end{figure}
 ...
 \begin{figure}[h]
 	...
 	\hspace{6 mm}
 	\subfloat[]{\includegraphics[width=0.4\textwidth]{./dn_mod}}
...
\begin{equation}
f_{c}=f_{s}\frac{1}{2 \pi}\frac{1-\alpha}{\alpha} \implies \alpha=\frac{f_{s} + 2 \pi f_{c}}{f_{c}}
\label{eq:alpha}
\end{equation}
	...
	\begin{table}[H]
		...
		\begin{tabular}{|c|c|c|c|c|c|}
			...
			\hline
			\hline Data Filter & $ 1kHz $ &  &  & & \\ 
			\hline Loop Filter & $ 10Hz $ &  &  & & \\ 
			\hline
		\end{tabular}
...
\begin{figure}[h]
	\centering
	\subfloat[]{\includegraphics[width=0.4\textwidth]{./captura}}
	\hspace{6 mm}
	\subfloat[]{\includegraphics[width=0.4\textwidth]{./segue}}
...
\begin{figure}[H]
	\centering
	\subfloat[]{\includegraphics[width=0.45\textwidth]{./tabela_cap}}
	\hspace{6 mm}
	\subfloat[]{\includegraphics[width=0.45\textwidth]{./tabela_segue}}
\end{figure}
